...
class Documentation(models.Model):
    ...
    author = models.ForeignKey(User, null=False, blank=False, on_delete=models.CASCADE, related_name='author')
    business_unit = models.ManyToManyField(BusinessUnit, null=True, blank=True, related_name='business_units')